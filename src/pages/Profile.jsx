...
import { User, ShoppingBag, Calendar, Edit3, Phone, Mail, MapPin, CheckCircle, LogOut, CreditCard } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button className="flex items-center text-orange-600 hover:text-orange-700 cursor-pointer">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          <button className="w-full text-left p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
          ...
          {[
            ...
            <div key={order.id} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
              ...
              <div className="mt-4 flex space-x-3">
                ...
                <button className="text-sm text-gray-600 hover:text-gray-700 font-medium cursor-pointer">
                  Track Order
                </button>
  ...
  const renderBookingsSection = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <button className="p-4 border border-orange-200 rounded-xl hover:bg-orange-50 transition-colors text-left cursor-pointer">
          ...
          <button className="p-4 border border-blue-200 rounded-xl hover:bg-blue-50 transition-colors text-left cursor-pointer">
      ...
      <div className="pt-16 md:pt-20">
        <div className="flex min-h-screen">
          ...
          <button
            ...
            className="fixed top-20 left-4 z-30 md:hidden bg-white p-2 rounded-lg shadow-lg border border-gray-200 cursor-pointer hover:bg-gray-50"
          >
        ...
        `}>
            ...
            <nav className="space-y-1 px-2">
              {menuItems.map((item) => (
                <button
                  ...
                  className={`
                    w-full flex items-center p-4 text-left rounded-lg transition-all duration-200 cursor-pointer
                    ${activeTab === item.id 
          ...
          <div className="p-3 border-t border-gray-200">
            <button
              onClick={logout}
              className="w-full flex items-center p-3 text-red-600 hover:bg-red-50 rounded-xl transition-colors cursor-pointer"
            >
